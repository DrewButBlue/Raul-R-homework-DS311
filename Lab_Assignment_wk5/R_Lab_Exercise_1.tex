...
\begin{Highlighting}[]
\CommentTok{\# Enter your code here.}
\NormalTok{vector\_of\_letters }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(letters)}
\NormalTok{vector\_of\_letters}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{matrix\_of\_LETTERS }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{c}\NormalTok{(LETTERS), }
               \AttributeTok{nrow =} \DecValTok{2}\NormalTok{,}
               \AttributeTok{byrow =}\NormalTok{ T)}
\NormalTok{matrix\_of\_LETTERS}
\end{Highlighting}
\end{Shaded}
